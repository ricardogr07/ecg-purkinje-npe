...
- [ ] Final numbers: the contraction table + coverage, on the real sweep (replace the Day-1 smoke figures).
...
- [ ] A one-paragraph "what we would do next" (anatomy generalization, real ECGs).
